...
const NumbersSection = () => {
  return (
    <div className="bg-black h-screen min-h-fit w-full pb-6 px-8  sm:px-12 md:px-16 lg:px-20 xl:px-32 2xl:px-60">
      <h2 className="text-2xl pb-12 text-center md:text-7xl lg:text-[50px] leading-tight lg:leading-[58px] font-semibold bg-gradient-to-r from-white to-white/90 text-transparent bg-clip-text">
