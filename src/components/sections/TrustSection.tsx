        ...
        <div className="flex flex-col gap-8">
          <div className="flex gap-5 animate-marquee hover:animate-none">
            {[...trustData, ...trustData].map((item, index) => (
              <div key={`top-${index}`} className="flex-shrink-0 w-[300px] mx-2">
                <TrustCards {...item} />
              </div>
            ))}
          </div>
          <div className="flex gap-5 animate-marquee-reverse hover:animate-none">
            {[...trustData, ...trustData].map((item, index) => (
              <div key={`bottom-${index}`} className="flex-shrink-0 w-[300px] mx-2">
                <TrustCards {...item} />
              </div>
            ))}
          </div>
