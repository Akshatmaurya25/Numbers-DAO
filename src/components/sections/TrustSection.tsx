...
const trustData1 = [
  ...
  { logo: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e", des: "Partnering with Numbers DAO gave us the confidence to scale globally. Their team understands blockchain like no other.", name: "John Doe", role: "CEO, ChainBridge" },
];

const trustData2 = [
  { logo: "https://images.pexels.com/photos/1181690/pexels-photo-1181690.jpeg", des: "Numbers DAO made blockchain infrastructure easy for us. We no longer worry about scaling issues!", name: "Sophia Martinez", role: "CEO, BlockSprint" },
  ...
  return (
    <div className="bg-black relative w-full min-h-screen flex flex-col items-center justify-center overflow-hidden p-20">
      <div className="z-20 text-center w-full relative">
        <div className="absolute z-50 top-0 left-0 w-full h-full bg-[linear-gradient(90deg,rgba(0,0,0,1)_0%,rgba(0,0,0,0)_10%,rgba(0,0,0,0)_50%,rgba(0,0,0,0)_90%,rgba(0,0,0,1)_100%)] lg:bg-[linear-gradient(90deg,rgba(0,0,0,1)_0%,rgba(0,0,0,0)_15%,rgba(0,0,0,0)_50%,rgba(0,0,0,0)_85%,rgba(0,0,0,1)_100%)]"></div>
