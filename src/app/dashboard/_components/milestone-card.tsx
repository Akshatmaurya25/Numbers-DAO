      ...
      <div className="bg-[#121212] xl:w-96 lg:w-10 rounded-xl overflow-hidden border border-gray-800 shadow-xl h-[20rem] flex flex-col">
        ...
        <div className="p-6 pb-2">
          ...
          <p className="text-gray-400 text-sm">
            Celebrating growth and achievements: A look back at moments that defined my 2024
          </p>
        </div>
        ...
        <div
          ref={scrollRef}
          className="flex-1 overflow-x-hidden hover:overflow-x-auto scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-transparent"
            ...
            {displayedMilestones.map((milestone, index) => (
              ...
              >
                ...
                <div className="flex items-center mb-3">
                  ...
                  <h3 className="text-white font-medium text-lg truncate">{milestone.title}</h3>
                </div>

                <p className="text-gray-400 text-sm mb-3 line-clamp-3">{milestone.description}</p>
